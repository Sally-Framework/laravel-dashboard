 ...
 * @property Type\Diagram\Doughnut $type
 */
class DoughnutTest extends AbstractDiagramTest
{
	...
	{
		return new Type\Diagram\Doughnut(self::TEST_STATISTIC_NAME, $this->factory);
	}
}