 ...
 * @property Type\DiagramBarVertical $type
 */
class DiagramBarVerticalTest extends AbstractDiagramTest
{
	...
	{
		return new Type\DiagramBarVertical(self::TEST_STATISTIC_NAME, $this->factory);
	}
}